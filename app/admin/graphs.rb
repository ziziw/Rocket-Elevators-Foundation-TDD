...
ActiveAdmin.register_page "Graphs" do
    content do
        connection = PG::Connection.new(host:'codeboxx-postgresql.cq6zrczewpu2.us-east-1.rds.amazonaws.com',port:'5432',dbname:'ZiWangChen',user:'codeboxx',password:'Codeboxx1!')
