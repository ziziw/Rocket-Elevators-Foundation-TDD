...
ActiveRecord::Schema.define(version: 2021_12_02_222134) do
  ...
  create_table "fact_interventions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "employee_id"
    t.bigint "building_id"
    t.bigint "battery_id"
    t.bigint "column_id"
